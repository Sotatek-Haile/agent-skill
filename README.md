...
|-------|---------|-------------|
| [lcp-bootstrap](./lcp-bootstrap/SKILL.md) | `/lcp:bootstrap` | Bootstrap Layered Context Protocol (LCP) for new or existing projects |
...
# Specific skill
npx github:Sotatek-Haile/agent-skill lcp-bootstrap
...
# Specific skill
npx --yes github:Sotatek-Haile/agent-skill lcp-bootstrap
```
